...
import 'package:backend_server/src/generated/lab_test_info.dart' as _i6;
import 'package:backend_server/src/generated/test_booking_dto.dart' as _i7;
import 'package:backend_server/src/generated/patient_reponse.dart' as _i8;
import 'package:backend_server/src/generated/greeting.dart' as _i9;
...
class _AdminEndpoints {
  ...
  _i3.Future<bool> addMedicineBatch(
    _i1.TestSessionBuilder sessionBuilder,
    int medicineId,
    String batchId,
    int stock,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminEndpoints',
            method: 'addMedicineBatch',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminEndpoints',
          methodName: 'addMedicineBatch',
          parameters: _i1.testObjectToJson({
  ...
  _i3.Future<List<Map<String, dynamic>>> getMedicineBatches(
    _i1.TestSessionBuilder sessionBuilder,
    int medicineId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminEndpoints',
            method: 'getMedicineBatches',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminEndpoints',
          methodName: 'getMedicineBatches',
          parameters: _i1.testObjectToJson({'medicineId': medicineId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<Map<String, dynamic>>> getLowStockItems(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
  ...
  _i3.Future<List<Map<String, dynamic>>> getRosters(
    _i1.TestSessionBuilder sessionBuilder, {
    String? staffId,
    DateTime? fromDate,
    DateTime? toDate,
  ...
  _i3.Future<Map<String, dynamic>> submitChangeRequest(
    _i1.TestSessionBuilder sessionBuilder, {
    required String rosterId,
    required String staffId,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminEndpoints',
          methodName: 'submitChangeRequest',
          parameters: _i1.testObjectToJson({
            'rosterId': rosterId,
            'staffId': staffId,
            'reason': reason,
  ...
  _i3.Future<List<Map<String, dynamic>>> getMyChangeRequests(
    _i1.TestSessionBuilder sessionBuilder,
    String staffId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminEndpoints',
            method: 'getMyChangeRequests',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminEndpoints',
          methodName: 'getMyChangeRequests',
          parameters: _i1.testObjectToJson({'staffId': staffId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<Map<String, dynamic>>> getAllChangeRequests(
    _i1.TestSessionBuilder sessionBuilder, {
    String? status,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<Map<String, dynamic>> updateRequestStatus(
    _i1.TestSessionBuilder sessionBuilder, {
  ...
  _i3.Future<List<Map<String, dynamic>>> getAuditLogs(
    _i1.TestSessionBuilder sessionBuilder,
    int limit,
    int offset,
  ) async {
  ...
  _i3.Future<List<Map<String, dynamic>>> listStaff(
    _i1.TestSessionBuilder sessionBuilder,
    int limit,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<String?> getAdminProfile(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<String> updateStaffProfile(
    _i1.TestSessionBuilder sessionBuilder,
    String userId, {
    String? name,
...
class _ProfileEndpoint {
  ...
  _i3.Future<List<_i6.LabTestInfo>> listLabTests(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.LabTestInfo>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i7.TestBookingDto>> listTestBookings(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'profile',
            method: 'listTestBookings',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'listTestBookings',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i7.TestBookingDto>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<Map<String, dynamic>?> searchPatient(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'searchTerm': searchTerm}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<String> createTestBooking(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'profile',
            method: 'createTestBooking',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'createTestBooking',
          parameters: _i1.testObjectToJson({
            'bookingId': bookingId,
            'patientId': patientId,
            'testIds': testIds,
  ...
  _i3.Future<bool> uploadTestResult(
    _i1.TestSessionBuilder sessionBuilder, {
    required String bookingId,
    String? testId,
    String? staffId,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'profile',
            method: 'uploadTestResult',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'uploadTestResult',
          parameters: _i1.testObjectToJson({
            'bookingId': bookingId,
            'testId': testId,
            'staffId': staffId,
  ...
  _i3.Future<String> downloadTestResult(
    _i1.TestSessionBuilder sessionBuilder,
    String bookingId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'profile',
            method: 'downloadTestResult',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'downloadTestResult',
          parameters: _i1.testObjectToJson({'bookingId': bookingId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
...
class _PatientEndpoint {
  ...
  _i3.Future<_i8.PatientProfileDto?> getPatientProfile(
    _i1.TestSessionBuilder sessionBuilder,
    String userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.PatientProfileDto?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
